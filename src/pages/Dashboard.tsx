...
const Dashboard = () => {
  const cryptoData = [
    { name: "Bitcoin", symbol: "BTC", price: "$43,256.00", change: "+2.34%", trending: "up" },
    { name: "Ethereum", symbol: "ETH", price: "$2,567.89", change: "-1.23%", trending: "down" },
    { name: "Cardano", symbol: "ADA", price: "$0.4567", change: "+5.67%", trending: "up" },
    { name: "Solana", symbol: "SOL", price: "$98.45", change: "+3.21%", trending: "up" },
  ];

  const portfolioMetrics = [
    { title: "Total Portfolio Value", value: "$12,543.67", change: "+8.45%", icon: DollarSign },
    { title: "24h Change", value: "+$1,234.56", change: "+5.67%", icon: TrendingUp },
    { title: "Active Positions", value: "8", change: "+2", icon: Activity },
    { title: "Profit/Loss", value: "+$2,456.78", change: "+12.34%", icon: BarChart3 },
  ];
  ...
  return (
    <div className="min-h-screen bg-background p-6 space-y-6">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-2">CryptoPeek Dashboard</h1>
            ...
            <Card key={index} className="border-border">
              ...
              <CardContent>
                ...
                <div className="flex items-center space-x-1 text-xs">
                  <span className={`text-${metric.change.startsWith('+') ? 'green' : 'red'}-500`}>
                    {metric.change}
                  </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="lg:col-span-2 border-border">
            <CardHeader>
              <CardTitle className="text-foreground">Top Cryptocurrencies</CardTitle>
              <CardDescription>Real-time price tracking and predictions</CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="font-semibold text-blue-500">Analysis</span>
                </div>
        ...
        <Card className="mt-6 border-border">
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                { action: "Bought", crypto: "BTC", amount: "0.1", price: "$43,200", time: "2 hours ago" },
                { action: "Sold", crypto: "ETH", amount: "2.5", price: "$2,580", time: "4 hours ago" },
                { action: "Alert", crypto: "ADA", amount: "Price target reached", price: "$0.45", time: "6 hours ago" },
              ].map((activity, index) => (
                <div key={index} className="flex items-center justify-between p-4 rounded-lg bg-muted/30">
                  <div className="flex items-center space-x-4">
                    <Badge variant={activity.action === "Bought" ? "default" : activity.action === "Sold" ? "destructive" : "secondary"}>
                      {activity.action}
                    </Badge>
                    <div>
